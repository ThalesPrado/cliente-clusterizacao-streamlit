...
# Re-calculating the correlation matrix including 'CAC (R$)_x' if it's not already included
# 'CAC (R$)_x' was already included in previous steps, but now ensuring its presence explicitly

# Computing the correlation matrix again to ensure all numeric columns, including CAC, are included
correlation_matrix = dados_sumarizados.corr()
