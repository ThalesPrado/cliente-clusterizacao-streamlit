...
# Criação do filtro para seleção do modelo de clusterização
selected_model = st.selectbox("Selecione o modelo de clusterização para visualizar os gráficos de dispersão:", 
                              options=list(model_labels.keys()), 
                              format_func=lambda x: model_labels[x])

# Criação do filtro para seleção de segmento
segment_options = df['Segmento'].unique()  # Pega todos os segmentos únicos
selected_segments = st.multiselect("Selecione o(s) segmento(s) para visualizar:", 
                                   options=segment_options, 
                                   default=segment_options)  # Default é todos os segmentos
