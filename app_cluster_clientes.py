...
- De maneira geral o algoritmo DBSCAN como outras vertentes que se baseam em densidade efine clusters como regiões de alta densidade de pontos separadas por áreas de baixa densidade. Conta com dois parâmetros principais sendo o epsilon a distância máxima para considerar um ponto dentro da vizinhança de outro e Minpts sendo o número mínimo de pontos necessários para que uma região seja considerada densa.
