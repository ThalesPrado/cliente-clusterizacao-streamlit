...
st.write("""2) Estando em um cenário de concorrência acirrada: qual estratégia comercial poderíamos implementar para diminuir nossa perda de clientes e quais clientes deveriamos priorizar para blindá-los de um eventual ataque da concorrência e por quê?
    ...
    -   2.Recomendação: Trabalhar com pacotes para grupos corporativos, eventos e outras festividades especiais visando aumentar a base de clientes.

    -   3.Recomendação: Implementar políticas de cross-selling entre empresas do mesmo grupo. Clientes que compram em nossa lojas de Restaurantes ganham benefícios em outros segmentos do grupo como Posto de Gasolina, Supermercado e etc.
...
st.write("""3) Dado o direcionamento de maximizar o lucro da Companhia, atual e futuro quais podem ser as sugestões?
    ...
    -   2.Recomendação: Realizar teste A/B para fazer Inferência dos canais que apresentam maior custo-benefício e focar os investimentos de marketing neles evitando desperdício de recursos em canais de baixo retorno.
    
    -   3.Recomendação: Implementar políticas de upselling para aumentar o ticket médio do cluster 0. Isso serve para campanhas de marketing e comunicação de modo geral ofertando melhor personalização para cada agrupamento.
""")
