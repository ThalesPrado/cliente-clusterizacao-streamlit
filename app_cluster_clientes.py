...
# Cria o multiselect com "Restaurante" como valor padrão
selected_segmento = st.multiselect("Selecione o Segmento", options=segmento_options, default=default_segmento, key="segmento_multiselect")
