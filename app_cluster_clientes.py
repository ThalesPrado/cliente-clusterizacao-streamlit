...
numerical_features = ['Volume transacional (R$)', 'Receita Transacional (R$)', 'Receita Antecipação de recebíveis (R$)', 'CAC (R$)']
...
for i, (cluster_col, title) in enumerate(model_labels.items()):
    ...
    sns.scatterplot(data=dados_brutos, x='Receita Transacional (R$)', y='CAC (R$)',
