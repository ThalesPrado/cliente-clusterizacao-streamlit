...
# Título do app
st.title("Análise de Clusterização de Clientes com Base Sumarizada")
...
if 'dados_sumarizados' in globals():
    ...
    st.write("### Amostra da Base Sumarizada")
    st.write(df.head())
    
    # Seleção das colunas numéricas relevantes para a clusterização
