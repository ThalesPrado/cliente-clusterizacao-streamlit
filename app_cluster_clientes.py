...
migra_0_para_1 = st.slider("Percentual de clientes migrando do Cluster 0 para o Cluster 1", min_value=0, max_value=100, value=10)
migra_0_para_2 = st.slider("Percentual de clientes migrando do Cluster 0 para o Cluster 2", min_value=0, max_value=100, value=5)
...
if 0 in cluster_summary.index and 1 in cluster_summary.index:
    # Calcular clientes migrando de Cluster 0 para 1
    clientes_migrando_0_para_1 = cluster_summary.loc[0, 'Num_Clientes'] * (migra_0_para_1 / 100)
...
if 0 in cluster_summary.index and 2 in cluster_summary.index:
    # Calcular clientes migrando de Cluster 0 para 2
    clientes_migrando_0_para_2 = cluster_summary.loc[0, 'Num_Clientes'] * (migra_0_para_2 / 100)
