...
# Configurar para exibir mais colunas se necessário
...
# Alterar o nome da coluna (sem usar inplace=True)
merged_base = merged_base.rename(columns={'CAC (R$)': 'CAC (R$)_x'})

# Retirar coluna
merged_base = merged_base.drop(columns=['CAC (R$)_y'])
...
# Novo DataFrame sem valores NaN
